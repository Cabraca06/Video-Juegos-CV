...
const juegos = [
    ...
    {id:18, nombre: 'The Last of Us Part II', genero: 'Aventura', imagen: thelastofus2Img, descripcion: 'The Last of Us Part II es un videojuego de acción y aventura desarrollado por Naughty Dog y publicado por Sony Interactive Entertainment.', videoId: "exampleVideoId8", precio: 69.99 },
    
    {id:19, nombre: 'Resident Evil Village', genero: 'Horror', imagen: residentEvilVlillageImg, descripcion: 'Resident Evil Village es un videojuego de survival horror desarrollado y publicado por Capcom.', videoId: "exampleVideoId9", precio: 59.99 },
    
    {id:20, nombre: 'Assassin\'s Creed Valhalla', genero: 'Aventura', imagen: assesingCreedValhallaImg , descripcion: 'Assassin\'s Creed Valhalla es un videojuego de acción y aventura desarrollado por Ubisoft Montreal y publicado por Ubisoft.', videoId: "exampleVideoId10", precio: 69.99 },
    
    {id:21, nombre: 'Cyberpunk 2077', genero: 'Ciencia Ficción', imagen: Cyberpunk2077Img, descripcion: 'Cyberpunk 2077 es un videojuego de rol de acción desarrollado por CD Projekt Red.', videoId: "exampleVideoId11", precio: 59.99 },
];
